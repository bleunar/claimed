...
import { Search, PencilSquare, PersonX, PersonCheck, Eye, PersonCircle, Plus, Backspace, Trash } from 'react-bootstrap-icons';
...
const AccountsPage = () => {
    ...
    }, [debouncedSearch, filterRole, filterStatus, includeDeleted]);
                ...
                <div className="card-body p-3">
                    <div className="row g-3">
                        ...
                        <div className="col-md-12 d-flex justify-content-between justify-content-md-end gap-2">
                            ...
                            <Button variant="primary" className='d-flex align-items-center' onClick={() => { fetchResults() }} title="Clear Filters">
                                <Search />
